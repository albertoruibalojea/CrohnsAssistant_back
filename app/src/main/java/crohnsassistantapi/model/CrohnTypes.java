...
public enum CrohnTypes {
    TYPE_ILEOCOLITIS ("PATTERN_ILEOCOLITIS", SymptomTypes.DIARRHEA.getPunctuation() + SymptomTypes.ABDOMINAL_PAIN.getPunctuation() +
    ...
    TYPE_ILEITIS ("PATTERN_ILEITIS", SymptomTypes.DIARRHEA.getPunctuation() + SymptomTypes.ABDOMINAL_PAIN.getPunctuation() +
    ...
    TYPE_COLITIS ("PATTERN_COLITIS", SymptomTypes.DIARRHEA.getPunctuation() + SymptomTypes.ABDOMINAL_PAIN.getPunctuation() +
    ...
    TYPE_UPPER_TRACT ("PATTERN_UPPER_TRACT", SymptomTypes.ABDOMINAL_PAIN.getPunctuation() + SymptomTypes.FEVER.getPunctuation() +
            SymptomTypes.NAUSEA.getPunctuation() + SymptomTypes.NOT_HUNGRY.getPunctuation() + SymptomTypes.WEIGHT_LOSS.getPunctuation() +
            SymptomTypes.APHTHAS.getPunctuation() + SymptomTypes.SKIN_RASH.getPunctuation()),
    TYPE_PERIANAL ("PATTERN_PERIANAL", SymptomTypes.DIARRHEA.getPunctuation() + SymptomTypes.ANAL_PAIN.getPunctuation() +
